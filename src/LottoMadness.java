/**
 * The program is a Lotto number cruncher that assesses a
 * user’s chance of winning one of the multimillion dollar Lotto contests in
 * the span of a lifetime. This chance is determined by running random sixnumber
 * Lotto drawings again and again until the user’s numbers turn up
 * as the big winner
 */
...
public class LottoMadness extends JFrame{
    ...
    JLabel numbersLabel = new JLabel("Your picksL ", JLabel.RIGHT);
